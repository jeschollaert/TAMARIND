...
The 17th-century oil painting created after French printmaker Nicolas de Larmessin II illustrates three men as the personifications of medicine, pharmacy, and surgery. At the center of the composition, the physician personifying medicine is cloaked in garb that bears the names of medieval authors central to traditional Western medicine, such as Avicenna and Mesue, two Persian polymaths credited by Tournefort as key nodes in the spread of knowledge about tamarind. Taking a closer look at the center of the painting, just under the hand of the man of medicine, reveals a prescription document to treat medical ailments—among plants like cassia and manna lies a reference to tamarind <span data-click-image-zoomto="366,572,344,300">prescription document</span>. 
